...
PATH = "~/Schreibtisch/uni/Robotik/catkin_ws_user/src/fub_navigation/src/"

class ForceController:
    def __init__(self):
        self.pub = rospy.Publisher("/AljoschaTim/steering", UInt8, queue_size = 1)
        self.pub_speed = rospy.Publisher("/AljoschaTim/speed", Int16, queue_size = 100, latch=True)
